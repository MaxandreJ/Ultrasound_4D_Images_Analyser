        ...
        function detecter(soi,handles)
            try
                ...
                switch soi.graphique.axe_abscisses_choisi
                    case 1
                        [y_maxs,abscisses_intensites_maximales,soi.largeurs_a_mi_hauteur,~] = findpeaks(courbe_ROI,abscisse_courbe_ROI,'SortStr','descend','NPeaks',soi.nombre_de_pics);
                        findpeaks(courbe_ROI,abscisse_courbe_ROI,'Annotate','extents','SortStr','descend','NPeaks',soi.nombre_de_pics);
                        y_maxs=y_maxs';
                    case 2
                        [y_maxs,abscisses_intensites_maximales,soi.largeurs_a_mi_hauteur,~] = findpeaks(courbe_ROI,abscisse_courbe_ROI,'SortStr','descend','NPeaks',soi.nombre_de_pics);
                        findpeaks(courbe_ROI,abscisse_courbe_ROI,'Annotate','extents','SortStr','descend','NPeaks',soi.nombre_de_pics);
